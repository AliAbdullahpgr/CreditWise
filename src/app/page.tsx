...
export default function LandingPage() {
  ...
  const featureUploadImage = PlaceHolderImages.find(
    (p) => p.id === "feature-upload",
  );
  const featureAnalyzeImage = PlaceHolderImages.find(
    (p) => p.id === "feature-analyze",
  );
  const featureScoreImage = PlaceHolderImages.find(
    (p) => p.id === "feature-score",
  );
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container bg-primary rounded-lg text-primary-foreground p-8 md:p-12 text-center">
            ...
            <p className="mx-auto max-w-[600px] mt-4">
              ...
              financial future. It's free and takes only 5 minutes.
            </p>
            <div className="mt-8">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">
          &copy; 2024 HisaabScore. All rights reserved.
        </p>
