...
import { Info, TrendingUp, DollarSign, Calendar, PieChart, CreditCard } from "lucide-react";
      ...
      <CardContent className="space-y-4">
        <div className="space-y-3">
          <p className="text-sm text-foreground/80">
            Traditional credit scores (FICO, VantageScore) require credit cards, bank loans,
            and mortgages. But <strong>gig workers, street vendors, and cash-based workers</strong> don't
            have these products!
          </p>
          ...
          <div className="bg-background/50 rounded-lg p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm font-medium">Income Consistency (25%)</p>
                  <p className="text-xs text-muted-foreground">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm font-medium">Expense Management (20%)</p>
                  <p className="text-xs text-muted-foreground">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="text-sm font-medium">Transaction Diversity (10%)</p>
                  <p className="text-xs text-muted-foreground">
