  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center justify-between text-xs text-muted-foreground">
        ...
        <span>{value}/100 → {contribution} points</span>
      </div>
    </div>
  );
}
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          How your Alternative Credit Score of {Math.round(totalScore)} is calculated
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="pt-4 border-t">
          <div className="flex items-center justify-between font-semibold">
            ...
            <span className="text-primary text-xl">{Math.round(totalScore)}/1000</span>
          </div>
